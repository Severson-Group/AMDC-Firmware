proc create_ipi_design { offsetfile design_name } {
	...
	set my_custom_adder_0 [ create_bd_cell -type ip -vlnv wisc.edu:user:my_custom_adder:1.0 my_custom_adder_0]
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores wisc.edu:user:my_custom_adder:1.0]]]]
