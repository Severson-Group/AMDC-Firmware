...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = amdc_analog
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = amdc_analog_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = amdc_encoder
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = amdc_encoder_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = amdc_inverters
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = amdc_inverters_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = tmrctr
 PARAMETER DRIVER_VER = 4.3
 PARAMETER HW_INSTANCE = control_timer_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = tmrctr
 PARAMETER DRIVER_VER = 4.3
 PARAMETER HW_INSTANCE = control_timer_1
END
