...
int uart_init(void)
{
	...
	// This is optional... I think the bsp is what is setting the baud rate,
	// not this code (i.e. this line can be removed and it still works)
...
//		char RecvChar = XUartPs_ReadReg(XPAR_XUARTPS_0_BASEADDR, XUARTPS_FIFO_OFFSET);
