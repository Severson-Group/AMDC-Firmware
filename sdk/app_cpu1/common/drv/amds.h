...
// UART DATA stream ZERO (one)
// FIRST AMDS
#define AMDS_CH_1_VALID_MASK ((uint32_t)0b000000000000000000000001)
#define AMDS_CH_2_VALID_MASK ((uint32_t)0b000000000000000000000010)
#define AMDS_CH_3_VALID_MASK ((uint32_t)0b000000000000000000000100)
#define AMDS_CH_4_VALID_MASK ((uint32_t)0b000000000000000000001000)
// SECOND AMDS
#define AMDS_CH_9_VALID_MASK  ((uint32_t)0b000000000000000000010000)
#define AMDS_CH_10_VALID_MASK ((uint32_t)0b000000000000000000100000)
#define AMDS_CH_11_VALID_MASK ((uint32_t)0b000000000000000001000000)
#define AMDS_CH_12_VALID_MASK ((uint32_t)0b000000000000000010000000)
// THIRD AMDS
#define AMDS_CH_17_VALID_MASK ((uint32_t)0b000000000000000100000000)
#define AMDS_CH_18_VALID_MASK ((uint32_t)0b000000000000001000000000)
#define AMDS_CH_19_VALID_MASK ((uint32_t)0b000000000000010000000000)
#define AMDS_CH_20_VALID_MASK ((uint32_t)0b000000000000100000000000)
// UART DATA stream ONE (two)
// FIRST AMDS
#define AMDS_CH_5_VALID_MASK ((uint32_t)0b000000000001000000000000)
#define AMDS_CH_6_VALID_MASK ((uint32_t)0b000000000010000000000000)
#define AMDS_CH_7_VALID_MASK ((uint32_t)0b000000000100000000000000)
#define AMDS_CH_8_VALID_MASK ((uint32_t)0b000000001000000000000000)
// SECOND AMDS
#define AMDS_CH_13_VALID_MASK ((uint32_t)0b000000010000000000000000)
#define AMDS_CH_14_VALID_MASK ((uint32_t)0b000000100000000000000000)
#define AMDS_CH_15_VALID_MASK ((uint32_t)0b000001000000000000000000)
#define AMDS_CH_16_VALID_MASK ((uint32_t)0b000010000000000000000000)
// THIRD AMDS
#define AMDS_CH_21_VALID_MASK ((uint32_t)0b000100000000000000000000)
#define AMDS_CH_22_VALID_MASK ((uint32_t)0b001000000000000000000000)
#define AMDS_CH_23_VALID_MASK ((uint32_t)0b010000000000000000000000)
#define AMDS_CH_24_VALID_MASK ((uint32_t)0b100000000000000000000000)

// LUT for CH VALID MASKS. Zero Indexed.
const static uint8_t AMDS_CH_VALID_MASK
    = { AMDS_CH_1_VALID_MASK,  AMDS_CH_2_VALID_MASK,  AMDS_CH_3_VALID_MASK,  AMDS_CH_4_VALID_MASK,
        AMDS_CH_5_VALID_MASK,  AMDS_CH_6_VALID_MASK,  AMDS_CH_7_VALID_MASK,  AMDS_CH_8_VALID_MASK,
        AMDS_CH_9_VALID_MASK,  AMDS_CH_10_VALID_MASK, AMDS_CH_11_VALID_MASK, AMDS_CH_12_VALID_MASK,
        AMDS_CH_13_VALID_MASK, AMDS_CH_14_VALID_MASK, AMDS_CH_15_VALID_MASK, AMDS_CH_16_VALID_MASK,
        AMDS_CH_17_VALID_MASK, AMDS_CH_18_VALID_MASK, AMDS_CH_19_VALID_MASK, AMDS_CH_20_VALID_MASK,
        AMDS_CH_21_VALID_MASK, AMDS_CH_22_VALID_MASK, AMDS_CH_23_VALID_MASK, AMDS_CH_24_VALID_MASK };
