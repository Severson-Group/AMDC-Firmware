...
#define AMDS_HIGH_VOLTAGE_DEFAULT_GAIN   256.0223 // note: high voltage default values are for 4.3kOhm resistors for R4, R6, and R8
#define AMDS_HIGH_VOLTAGE_DEFAULT_OFFSET 2.5031 //  (not what the schematic states but all of our high voltage cards are assembled with these)
...
#define AMDS_CURRENT_DEFAULT_GAIN        24.412
