...
The `dac` command is used to interact with this application. The `init`, `deinit`, and `freq` subcommands are used to operate the sample function generator application. The remaining subcommands directly interact with the DAC expansion board.
